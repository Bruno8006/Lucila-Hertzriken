...
async def get_projects():
    return sorted(projects_storage, key=lambda x: x.order)
...
async def update_project(project_id: str, project_data: ProjectUpdate, current_user: str = Depends(verify_token)):
    project_index = None
    for i, project in enumerate(projects_storage):
    ...
    # Update the project
    current_project = projects_storage[project_index]
    updated_project = current_project.copy(update=update_data)
    projects_storage[project_index] = updated_project
...
async def delete_project(project_id: str, current_user: str = Depends(verify_token)):
    ...
    projects_storage.pop(project_index)
